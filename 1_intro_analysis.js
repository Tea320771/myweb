    ...
    try {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.warn("가이드라인 파일을 찾을 수 없습니다.");
            }
        } catch (e) {
        ...
        [참고: 해석 가이드라인 (학습 데이터)]
        아래 JSON 데이터는 사용자가 지정한 '해석 지침'이다. 특히 '주문'의 소송비용 부담 비율 계산 시 이 지침의 예시와 논리를 최우선으로 참고해라.
        ${guidelineText}
        ...
        6. **소송비용 부담 비율 및 주문 텍스트 (상세 분석)**: 
           ...
           - **상기 '해석 가이드라인'에 유사한 주문 예시가 있다면 반드시 그 해석 방식을 따를 것.**
